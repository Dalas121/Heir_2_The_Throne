...
- Normal:    1.5x enemy/ally strength,  90% xp to level, 80% starting gold (ignoring carryover)
- Hard:      2.0x enemy/ally strength, 110% xp to level, 65% starting gold (ignoring carryover)
